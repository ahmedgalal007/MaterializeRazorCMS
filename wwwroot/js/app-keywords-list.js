...
const LocalizationHelper = {
  ...
  AddLocalization: function () {
    const newLang = $(`#edit${entityName}Form`).find('#inputGroupSelectLanguage').find(":selected").val();
    ...
    LocalizationHelper.GenerateAllLocalizations($(`#edit${entityName}Form`).find('ul.nav-tabs'), $(`#edit${entityName}Form`).find('.localizations-tabs-contents'));
    }
  },
